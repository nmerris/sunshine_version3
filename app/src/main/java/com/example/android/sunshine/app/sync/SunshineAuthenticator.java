...
/**
 * This is a 'stub' authenticator service, required for sync adapters in all cases, even though
 * this app does not need user account credientials to log in to OpenWeatherMap.
 *
